        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                    <li class="nav-item">
                        <a href="index.php" class="nav-link smoothScroll">Accueil</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="index.php #about" class="nav-link smoothScroll">À propos</a>
                    </li>
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-8 col-md-10 mx-auto col-12">
                              <div class="hero-text mt-5 text-center">
                                    ...
                                    <h1 class="text-white" data-aos="fade-up" data-aos-delay="200">Impression numérique Grands formats</h1>

                                    <p data-aos="fade-up" data-aos-delay="400">Notre position de partenaire chez nos clients dans <a rel="nofollow" target="_parent">le domaine de l'Environnement, Communauté d'Agglomération, Mairies, Conseil Général, Marques de luxe, Services de Communication,</a> font de nous un des acteurs privilégié dans cette activité en France.</p>
               ...
               <div class="container">
                    <div class="row">
                            ...
                            <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                                <h2 class="mb-4" data-aos="fade-up" data-aos-delay="200">Impression Numérique</h2>

                                <p data-aos="fade-up" data-aos-delay="300">
                                - Bâches - Kakémonos </br>
                                - Magnets - système velleda </br>
                                - Panneaux Dibond</br>
                                - Panneaux Forex </br>
                                - Panneaux de chantier alvéolés (Akilux) </br>
                                - Adhésifs transparent - Décor de vitrine </br>
                                - Adhésifs de sol - lettres découpées </br></br>
                            ...
                            <div class="ml-lg-auto col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                                <div class="team-thumb">
                                    <img src="images/acuity.jpg" class="img-fluid" alt="Trainer">

                                    <div class="team-info d-flex flex-column">

                                        <h3>Table d'impression</h3>
                                        <span>Acuity F</span>
               ...
               <div class="container">
                    <div class="row">
                            ...
                            <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-6 col-md-10 mx-auto col-12">
                                <h2 class="mb-4" data-aos="fade-up" data-aos-delay="200">Découpe numérique</h2>

                                <p data-aos="fade-up" data-aos-delay="300">
                                - Luxe </br>
                                - Publicitaire </br>
                                - Électronique</br>
                                - Usage industriels </br>
                                - Industrie Automobile </br>
                                - Application de sécurité, impression doming</br>
                                rouleaux étiquettes adhésives </br>
                            </p>
                            </div>

                            <div class="ml-lg-auto col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                                <div class="team-thumb">
                                    <img src="images/zund1.png" class="img-fluid" alt="Trainer">
                            ...
                            <div class="mr-lg-auto mt-5 mt-lg-0 mt-md-0 col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                                <div class="team-thumb">
                                    <img src="images/zund2.png" class="img-fluid" alt="Trainer">
